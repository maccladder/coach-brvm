...
class BetCouponController extends Controller
{
    ...
    {
        $ordre = ['sur' => 0, 'equilibre' => 1, 'jackpot' => 2, 'crazy' => 3, 'goals' => 4, 'pepite05' => 5, 'tennis_sur' => 6, 'tennis_equilibre' => 7, 'tennis_jackpot' => 8];
    ...
    public function apiStore(Request $request)
    {
        ...
        $data = $request->validate([
            ...
            'niveau'       => 'required|in:sur,equilibre,jackpot,crazy,goals,pepite05,tennis_sur,tennis_equilibre,tennis_jackpot',
