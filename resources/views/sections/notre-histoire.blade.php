...
@push('styles')
<style>
    .histoire-page { background:var(--cb-paper);min-height:100vh; }
    .histoire-hero { background:radial-gradient(ellipse 80% 50% at 50% 0%,rgba(15,92,67,.08) 0%,transparent 55%),var(--cb-paper);border-bottom:1px solid var(--cb-border);padding:48px 0 36px;position:relative;overflow:hidden; }
    .histoire-hero-grid { position:absolute;inset:0;background-image:linear-gradient(rgba(15,92,67,.04) 1px,transparent 1px),linear-gradient(90deg,rgba(15,92,67,.04) 1px,transparent 1px);background-size:56px 56px;mask-image:radial-gradient(ellipse 80% 70% at 50% 50%,black 0%,transparent 70%);pointer-events:none; }
    .histoire-hero-tag { font-family:'Syne',sans-serif;font-size:11px;font-weight:600;letter-spacing:.2em;text-transform:uppercase;color:var(--cb-forest);display:flex;align-items:center;gap:10px;margin-bottom:14px; }
    .histoire-hero-tag::before { content:'';width:28px;height:1px;background:var(--cb-forest); }
    .histoire-hero-title { font-family:'Playfair Display',serif;font-size:clamp(28px,5vw,48px);font-weight:900;color:var(--cb-ink);line-height:1.08;margin-bottom:10px; }
    .histoire-hero-title em { font-style:italic;color:var(--cb-gold); }
    .histoire-article { background:var(--cb-card);border:1px solid var(--cb-border);border-radius:4px;padding:40px 44px;margin-top:32px; }
    .histoire-h { font-family:'Playfair Display',serif;font-size:22px;font-weight:700;color:var(--cb-gold);margin:28px 0 12px; }
    .histoire-h:first-child { margin-top:0; }
    .histoire-p { font-size:14px;color:var(--cb-muted);line-height:1.85;margin-bottom:16px; }
    .histoire-em { font-style:italic;color:var(--cb-ink); }
    .histoire-ul { list-style:none;padding:0;margin-bottom:20px; }
    .histoire-ul li { font-size:13.5px;color:var(--cb-muted);padding:8px 0;border-bottom:1px solid var(--cb-border);display:flex;align-items:flex-start;gap:10px; }
    .histoire-ul li::before { content:'→';color:var(--cb-gold);flex-shrink:0;margin-top:1px; }
    .histoire-mission-box { background:rgba(15,92,67,.05);border:1px solid rgba(15,92,67,.12);border-radius:3px;padding:20px 24px;margin-top:24px; }
    .histoire-mission-text { font-size:14px;color:var(--cb-muted);line-height:1.75; }
    .histoire-mission-text strong { color:var(--cb-ink); }
...
<div class="histoire-page">
    <div class="histoire-hero">
        ...
        <div class="container" style="max-width:900px;position:relative;z-index:1;">
            ...
            <p style="font-size:14px;color:var(--cb-muted);font-weight:300;">Boursiv est né d'une expérience réelle, d'un parcours d'investisseurs passionnés mais souvent livrés à eux-mêmes.</p>
        </div>
    </div>
    <div class="container py-5" style="max-width:900px;">
        <div class="histoire-article cbr">
            ...
            <p class="histoire-p">C'est ainsi qu'est né <strong style="color:var(--cb-ink);">Boursiv</strong> : une plateforme pensée pour les débutants, mais utile aussi aux investisseurs confirmés.</p>
