  ...
  <div class="row justify-content-center mb-4">
    <div class="col-lg-8 text-center">
      ...
      <p class="text-muted fs-5">
        ...
        Pour seulement <span class="fw-bold text-success">100 FCFA</span>, notre IA lit, interprète et résume votre BOC.
      </p>
    </div>
  </div>
      ...
      <div class="card shadow-sm border-0">
        ...
        <div class="card-body d-flex flex-column flex-md-row text-center text-md-start border-top">
          ...
          <div>
            ...
            <p class="mb-0 text-muted">Payez seulement <span class="fw-bold text-success">100 FCFA</span> via MTN, Orange ou Wave.</p>
          </div>
        ...
        <div class="card-body">
          ...
          <form action="{{ route('client-bocs.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <button type="submit" class="btn btn-success btn-lg w-100 fw-bold">
              🚀 Envoyer & Démarrer l’analyse (100 FCFA)
            </button>
          </form>
