...
<style>
    ...
    .recap-header { background:var(--cb-card);border-bottom:1px solid rgba(192,57,43,.12);padding:28px 0; }
    ...
    .recap-card { background:var(--cb-card);border:1px solid rgba(192,57,43,.12);border-radius:4px;overflow:hidden;margin-top:28px;margin-bottom:48px; }
    .recap-card::before { content:'';display:block;height:2px;background:linear-gradient(90deg,var(--cb-down),rgba(176,134,46,.5),transparent); }
    ...
    .recap-cell { background:rgba(15,92,67,.03);border:1px solid var(--cb-border);border-radius:3px;padding:14px 16px; }
    .recap-cell-label { font-family:'Syne',sans-serif;font-size:10px;font-weight:600;letter-spacing:.1em;text-transform:uppercase;color:var(--cb-muted);margin-bottom:6px; }
    .recap-cell-value { font-family:'Playfair Display',serif;font-size:20px;font-weight:700;color:var(--cb-ink); }
    ...
    .recap-row-value { font-size:14px;color:var(--cb-ink); }
    .recap-hint { font-size:12px;color:var(--cb-muted);margin-top:3px; }

    .recap-net-box { background:rgba(15,92,67,.05);border:1px solid rgba(15,92,67,.15);border-radius:3px;padding:16px 20px;display:flex;justify-content:space-between;align-items:center;margin-top:16px;flex-wrap:wrap;gap:10px; }
    .recap-net-label { font-family:'Syne',sans-serif;font-size:11px;font-weight:700;letter-spacing:.1em;text-transform:uppercase;color:var(--cb-forest); }
    .recap-net-value { font-family:'Playfair Display',serif;font-size:28px;font-weight:900;color:var(--cb-forest); }
    ...
    .cb-btn-sell:hover { box-shadow:0 8px 24px rgba(192,57,43,.3);transform:translateY(-1px); }
    .cb-btn-back { display:inline-flex;align-items:center;justify-content:center;gap:8px;background:transparent;color:var(--cb-muted) !important;font-family:'Syne',sans-serif;font-weight:600;font-size:12px;letter-spacing:.07em;text-transform:uppercase;padding:13px 20px;border:1px solid var(--cb-border);border-radius:3px;text-decoration:none;transition:all .3s; }
        ...
        <div class="recap-card cbr">
            <div class="recap-card-body">
                ...
                <div style="display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:20px;flex-wrap:wrap;gap:12px;">
                    <div>
                        <div style="font-family:'Playfair Display',serif;font-size:28px;font-weight:900;color:var(--cb-down);line-height:1;">{{ $ticker }}</div>
                        <div style="font-size:13px;color:var(--cb-muted);margin-top:2px;">{{ $name }}</div>
                    </div>
                    <div style="text-align:right;">
                        <div style="font-family:'Syne',sans-serif;font-size:10px;font-weight:600;letter-spacing:.1em;text-transform:uppercase;color:var(--cb-muted);margin-bottom:4px;">Quantité détenue</div>
                        <div style="font-size:16px;color:var(--cb-ink);font-weight:600;">{{ number_format($ownedQty,0,',',' ') }} titre(s)</div>
                    </div>
                </div>
                ...
                <div class="recap-row">
                    ...
                    <span class="recap-row-value" style="color:var(--cb-down);">− {{ number_format($fee,0,',',' ') }} FCFA</span>
                </div>
